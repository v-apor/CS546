...
export const createUser = async (
    ...
    if (!firstName || typeof firstName !== "string") {
        throw new Error("First name must be provided as a non-empty string.");
    }
    ...
    if (!lastName || typeof lastName !== "string") {
        throw new Error("Last name must be provided as a non-empty string.");
    }
    ...
    // Although not specified, should also check for atleast one lowercase
    if (!/[a-z]/.test(password)) {
        throw new Error(
